        ...
        return (
            <div>
              ...
              <form id="new-session">
                ...
                <section className="search-time-container" className="form-section">
                ...
                <section className="form-section session-type-section">
                  ...
                  <input type="radio" name="session-type" name="session-type" id="session-type-blind" value="1" className="session-type-radio" />
